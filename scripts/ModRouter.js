...
class RadioClimat {
    ...
    getWeekShchedule = () => {
        return this.getData(`${this.SERVER}/api/v2/grid/?end_ts=1609102800&server=1&start_ts=1608498000`)
    }
...
const createRadioPage = (response) => {
...
const createPodcastsPage = () => {
    ...
    let podcasts = ` <div class="center-content-page schedule--center-content-page" >
    <div class="leading__block center-content-body__block">
...
let Router = {
    ...
    radio: function () {
        radioClimat.getCurrent().then(response => createRadioPage(response));
    },
    ...
    main: function () {
        ...
        radioClimat.getCurrent().then(response => createMainPage(response)).then(() => {
            createPodcastsPage();
        });
